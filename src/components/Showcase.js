...
function Showcase() {
  return (
    <>
        <section className='flex flex-col-reverse pl-8 py-20 lg:grid lg:grid-cols-2 lg:gap-16 lg:place-items-center max-w-5xl mx-auto'>
            <article className='text-center lg:text-left'>
                ...
                <ul className='mt-10 flex items-center justify-center flex-wrap gap-4 lg:text-left'>
                    <li><button className='bg-indigo-600 text-white py-2 px-4 rounded shadow-lg font-bold hover:opacity-75'>Get it on chrome</button></li>
